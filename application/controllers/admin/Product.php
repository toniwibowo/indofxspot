...
$js = $categories->get_js();
  ...
  public function create_table()
  {
    $sql = "CREATE TABLE type_category (
      type_category_id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
      type_name_id VARCHAR(100) NOT NULL,
      type_name_en VARCHAR(30) NOT NULL,
      active TINYINT(1),
  ...
  {
    $sql = "ALTER TABLE category_product ADD type_category_id INT(11) after category_product_id";
