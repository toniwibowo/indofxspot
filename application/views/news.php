            ...
            <div class="col-sm-6">
              <article class="post post-medium border-0 pb-0 mb-5">
                ...
                <div class="post-content">
                  ...
                  <h2 class="font-weight-semibold text-5 line-height-6 mt-3 mb-2"><a href="<?php echo site_url('news/detail/'.$r['news_id'].'/'.url_title($r['title'])) ?>"><?php echo $r['title']; ?></a></h2>
                  ...
                  <div class="post-meta">
                   <!-- <span><i class="far fa-user"></i> By <a href="#">Bob Doe</a> </span>
                    ...
                    <span class="d-block mt-2"><a href="<?php echo site_url('news/detail/'.$r['news_id'].'/'.url_title($r['title'])); ?>" class="btn btn-xs btn-light text-1 text-uppercase">Read More</a></span>
                  </div>
