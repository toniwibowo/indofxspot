    ...
    <div class="row py-3">
      <div class="col-md-6 mb-5 mb-lg-0 pt-3 bg-primary">
        <div class="row justify-content-center">
          <div class="col-md-8 col-12 align-self-center">
            ...
            <p>PT Indosan Berkat Bersama didirikan pada awal tahun 2018 lalu di Jakarta. Kami adalah penyedia solusi keamanan dan keselamatan untuk berbagai segmen mulai dari komersial, industrial sampai rumah tinggal. Kami menyediakan solusi penyimpanan yang aman, solusi terhadap kebakaran dan keselamatan serta solusi keamanan bangunan.</p>
      ...
      <div class="col-md-6 mb-5 mb-lg-0 pt-3 bg-danger text-center">
        ...
        <ul class="social-icons mt-4">
          <li class="social-icons-facebook"><a href="https://www.facebook.com/MyIndosan/" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
