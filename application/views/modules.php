<div class="callout callout-info">
	...
	<p>The menu and database in installed module must create or import manually, click detail module for information.</p>
</div>
				...
				<?php $i = 1; foreach ($modules as $key => $path): ?>
					<?php if ($key != 0 && $key != 1): ?>
						<tr>
							<th><?php echo $i ?></th>
							<td>
								<strong><a href="<?php echo site_url('sketsanet/module_detail/'.$path); ?>" title="Detail"><?php echo $path ?></a></strong>
							</td>
							<td class="text-right">
								<a href="<?php echo site_url('sketsanet/module_delete/'.$path); ?>" title="Remove"><i class="fa fa-trash"></i> Remove</a>								
							</td>
						</tr>
					<?php $i++; endif ?>
				<?php endforeach ?>
