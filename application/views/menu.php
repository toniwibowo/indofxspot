<div class="row">
        ...
        <div class="list-group">
          <?php foreach ($menu_type as $value): ?>
            ...
            <?php if ($value->id_menu_type != 1): ?>
              <a href="<?php echo site_url('sketsanet/menu_type/'.$url.'/delete/'.$value->id_menu_type) ?>" title="Delete menu type"><i class="fa fa-trash"></i> Delete</a>
            <?php endif ?>
            <a href="<?php echo site_url('sketsanet/menu/'.$url) ?>" class="list-group-item <?php echo $active ?>"><?php echo $value->type ?></a>
            <br>
          <?php endforeach ?>
        </div>
        <div class="form-group">
          <a href="<?php echo site_url('sketsanet/menu_type/'.$this->uri->segment(3).'/add') ?>" class="btn btn-primary btn-block btn-flat"><i class="fa fa-plus-circle"></i> Add Menu Type</a>
        </div> 
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="box box-default">
      ...
      <div class="box-body">
        <?php echo form_open('sketsanet/update_menu') ?>
          <div class="form-group">
            <a href="<?php echo site_url('sketsanet/crud_menu/'.$this->uri->segment(3).'/add') ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus-circle"></i> Add Menu</a>
